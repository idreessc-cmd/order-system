...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("Error in admin-get-pricing API:", error);
    return res.status(500).json({ success: false, message: "حدث خطأ داخلي في /api/admin-get-pricing.", debug: error.message });
  }
}
