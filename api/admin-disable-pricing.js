...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("Error in admin-disable-pricing API:", error);
    return res.status(500).json({ success: false, message: "حدث خطأ داخلي في /api/admin-disable-pricing.", debug: error.message });
  }
}
